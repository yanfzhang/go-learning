...
For example, the syntax highlighting on this site is implemented by spawning a pygmentize process from a Go program. Let’s look at a few examples of spawning processes from Go.
*/
package main
...
func main() {
	...
	// We ommited error checks in the above example, but you could use the usual if err != nil pattern for all of them.
