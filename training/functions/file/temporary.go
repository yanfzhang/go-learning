...
func main() {
	...
	// The easiest way to create a temporary file is by calling ioutil.TempFile. It creates a file and opens it for reading and writing.
	// We provide "" as the first argument, so ioutil.TempFile will create the file in the default location for our OS.
	f, err := ioutil.TempFile("", "sample")
	checkT(err)

	// Display the name of the temporary file. On Unix-based OSes the directory will likely be /tmp.
	// The file name starts with the prefix given as the second argument to ioutil.TempFile and the rest is chosen automatically to ensure that concurrent calls will always create different file names.
...
/**
Temp file name: /var/folders/sx/jl4kbkgn6f1fwxfbdfz95y1w0000gn/T/sample103107745
Temp dir name: /var/folders/sx/jl4kbkgn6f1fwxfbdfz95y1w0000gn/T/sampledir748536716
*/
