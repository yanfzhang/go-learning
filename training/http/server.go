...
func hello(w http.ResponseWriter, req *http.Request) {
	...
	// The response writer is used to fill in the HTTP response. Here our simple response is just “helloC\n”.
	fmt.Fprintf(w, "helloC\n")
}
